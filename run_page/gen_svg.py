...
def main():
    ...
    args_parser.add_argument(
        ...
        type=str,
        default="#95E7A6",
        help='Color of tracks (default: "#95E7A6").',
    )
    args_parser.add_argument(
        "--track-color2",
        dest="track_color2",
    ...
    args_parser.add_argument(
        ...
        type=str,
        default="#203958",
        help='Color of text (default: "#000000").',
    )
    args_parser.add_argument(
        "--special-color",
        dest="special_color",
        metavar="COLOR",
        default="#0E9A2C",
        help='Special track color (default: "#67DB80").',
    )
    args_parser.add_argument(
        "--special-color2",
        dest="special_color2",
        metavar="COLOR",
        default="#F7CA12",
        help="Secondary color of special tracks (default: 0E7524).",
    )
    args_parser.add_argument(
        "--units",
        dest="units",
